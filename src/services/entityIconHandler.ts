...
function entityIconHandler(objectKey: IconObjectKey) {
	if (objectKey === 'house_number') {
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
  		<path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L8 2.207l6.646 6.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293z"/>
  		<path d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293z"/>
		</svg>`;
	} else if (objectKey === 'road') {
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-sign-stop-lights-fill" viewBox="0 0 16 16">
		...
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-buildings-fill" viewBox="0 0 16 16">
  		<path d="M15 .5a.5.5 0 0 0-.724-.447l-8 4A.5.5 0 0 0 6 4.5v3.14L.342 9.526A.5.5 0 0 0 0 10v5.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V14h1v1.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5zM2 11h1v1H2zm2 0h1v1H4zm-1 2v1H2v-1zm1 0h1v1H4zm9-10v1h-1V3zM8 5h1v1H8zm1 2v1H8V7zM8 9h1v1H8zm2 0h1v1h-1zm-1 2v1H8v-1zm1 0h1v1h-1zm3-2v1h-1V9zm-1 2h1v1h-1zm-2-4h1v1h-1zm3 0v1h-1V7zm-2-2v1h-1V5zm1 0h1v1h-1z"/>
		</svg>`;
	} else if (objectKey === 'suburb') {
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-signpost-2-fill" viewBox="0 0 16 16">
		...
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-pin-map-fill" viewBox="0 0 16 16">
  		<path fill-rule="evenodd" d="M3.1 11.2a.5.5 0 0 1 .4-.2H6a.5.5 0 0 1 0 1H3.75L1.5 15h13l-2.25-3H10a.5.5 0 0 1 0-1h2.5a.5.5 0 0 1 .4.2l3 4a.5.5 0 0 1-.4.8H.5a.5.5 0 0 1-.4-.8z"/>
  		<path fill-rule="evenodd" d="M4 4a4 4 0 1 1 4.5 3.969V13.5a.5.5 0 0 1-1 0V7.97A4 4 0 0 1 4 3.999z"/>
		</svg>`;
	} else if (objectKey === 'state') {
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-compass-fill" viewBox="0 0 16 16">
		...
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-mailbox2-flag" viewBox="0 0 16 16">
		...
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-map-fill" viewBox="0 0 16 16">
			<path fill-rule="evenodd" d="M16 .5a.5.5 0 0 0-.598-.49L10.5.99 5.598.01a.5.5 0 0 0-.196 0l-5 1A.5.5 0 0 0 0 1.5v14a.5.5 0 0 0 .598.49l4.902-.98 4.902.98a.5.5 0 0 0 .196 0l5-1A.5.5 0 0 0 16 14.5zM5 14.09V1.11l.5-.1.5.1v12.98l-.402-.08a.5.5 0 0 0-.196 0zm5 .8V1.91l.402.08a.5.5 0 0 0 .196 0L11 1.91v12.98l-.5.1z"/>
		</svg>`;
	} else if (objectKey === 'country_code') {
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-globe-central-south-asia" viewBox="0 0 16 16">
		...
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-alphabet" viewBox="0 0 16 16">
		...
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-signpost-split-fill" viewBox="0 0 16 16">
		...
		return `
		<svg xmlns="http://www.w3.org/2000/svg" width="${SVG_ICON_SIZE}" height="${SVG_ICON_SIZE}" fill="currentColor" class="bi bi-broadcast" viewBox="0 0 16 16">
